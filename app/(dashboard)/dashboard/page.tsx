...
export default async function DashboardPage({
  ...
  return (
    <div>
      ...
      />
      <form className="mb-4 flex flex-col gap-3 rounded-xl border bg-white p-4 shadow-soft md:flex-row md:items-end">
        <div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <Card>
          ...
          <CardContent className="text-2xl font-semibold">{analytics.kpis.totalActiveLoans}</CardContent>
        </Card>
        <Card>
          <CardHeader>
            <CardTitle>Total Loan Portfolio Value</CardTitle>
          </CardHeader>
          <CardContent className="text-2xl font-semibold">{toCurrency(analytics.kpis.totalLoanPortfolioValue)}</CardContent>
        </Card>
        <Card>
          <CardHeader>
            <CardTitle>Total Investor Capital</CardTitle>
          </CardHeader>
          <CardContent className="text-2xl font-semibold">{toCurrency(analytics.kpis.totalInvestorCapital)}</CardContent>
        </Card>
        <Card>
          <CardHeader>
            <CardTitle>Late Loans Count</CardTitle>
          </CardHeader>
          <CardContent className="text-2xl font-semibold">{analytics.kpis.lateLoansCount}</CardContent>
        </Card>
      </div>
